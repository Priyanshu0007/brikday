  ...
  return (
    <SlideContent index={1} activeIndex={activeIndex}>
      ...
      <Typography variant="body" style={styles.slideDescription}>
        Create habits you do every day. Check them off and build a streak. Miss a day? Your card
        turns red to remind you to stay consistent.
      </Typography>
        ...
        <BrutalistCard accentColor={theme.colors.success}>
          <View style={styles.habitPreviewRow}>
            <View style={styles.checkboxDone}>
              <Typography variant="bodyBold" style={styles.checkmark}>
                ✓
              </Typography>
            </View>
            <View style={styles.habitPreviewText}>
              <Typography variant="bodyBold" style={styles.doneText}>
                6AM CLUB WAKEUP
              </Typography>
