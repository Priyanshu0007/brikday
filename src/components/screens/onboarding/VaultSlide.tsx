  ...
  return (
    <SlideContent index={2} activeIndex={activeIndex}>
      ...
      <Typography variant="body" style={styles.slideDescription}>
        Want something expensive? Create a savings goal. Log each deposit with its source. When you
        hit 100%, buy it outright. No EMIs, no debt, full ownership.
      </Typography>
          ...
          <View style={styles.progressBarBg}>
            <View
              style={[
                ...
                { width: '60%', backgroundColor: theme.colors.warning },
              ]}
            />
          </View>
          <View style={styles.progressRow}>
            <Typography variant="caption">{currencySymbol}2,100 saved</Typography>
            <Typography variant="caption" style={styles.progressRight}>
              {currencySymbol}3,500 goal
            </Typography>
          </View>
        </BrutalistCard>
